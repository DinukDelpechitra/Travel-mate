...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:5000/api/package', newPackage)
      .then(response => {
  ...
  const handleEditSubmit = (e) => {
    ...
    axios.put(`http://localhost:5000/api/package/${editPackage._id}`, editPackage)
      .then(response => {
  ...
  const handleDelete = (packageID) => {
    ...
    if (confirmDelete) {
      axios.delete(`http://localhost:5000/api/package/${packageID}`)
        .then(() => {
          setPackages(prevPackages =>
